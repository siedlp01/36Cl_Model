function Nf = modelscarp(data,coll,age,slip,preexp,EL,epsilon,alpha,beta,gamma,Hfinal,rho_coll,rho_rock)
...
disp(['Pre-exp: ', num2str(preexp)]);
disp(['Slip: ', num2str(slip)]);
disp(['Ages: ', num2str(age)]);
disp(['RMSw = ', num2str(rmsw), ', chi2 = ', num2str(chi_square), ', AICc =', num2str(aicc), ', i = ', num2str(i)]);
%----------- AICC FUNCTION ---------
