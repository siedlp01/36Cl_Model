 function P_cosmo = clcoll(coll,sample,Lambda_f,so_f,EL_f,EL_mu,Psi_Cl36_Ca_0,rho_rock,rho_coll)
...
phi_star_th = (p_E_th_a*R_th*phi_star_eth)/(Lambda_eth*(Sigma_th - D_th/(Lambda_f^2))) ;
